...
static void BOARD_ConfigTouchIntPin(gt911_int_pin_mode_t mode)
{
    ...
    else
    {
        ...
        rt_kprintf("BOARD_ConfigTouchIntPin mode:%d\n", mode);
...
static void DEMO_InitTouch(void)
{
    ...
    rt_kprintf("kGPIO_DigitalOutput\n");
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_INT_PIN, 0);
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_RST_PIN, 0);
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_INT_PIN, 1);
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_RST_PIN, 1);
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_INT_PIN, 0);
    GPIO_PinWrite(BOARD_TOUCH_INT_GPIO, BOARD_TOUCH_RST_PIN, 0);
...
AG:
    ...
    rt_kprintf("status :%d\n",status);
     ...
     {
        rt_kprintf("Touch panel init failed\n");
        //assert(0);
        rt_thread_delay(500);
        goto AG;
     }
